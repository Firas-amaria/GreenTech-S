// Example usage in a test file (ES module):
import { activeDeliverers } from "./data/activeDeliverers.mock.js";
import { STANDARD_PACKAGE_DIMS_CM, PACKAGE_MAX_KG } from "./data/packages-std-sizes.js";
import { LOGISTIC_CENTERS } from "./data/logistics-centers.mock.js";
import { ROUTING_CONFIG } from "./data/routing-config.js";

// Pick best deliverer for Large by capacity
const bestLarge = [...activeDeliverers].sort((a,b) => b.capacity.maxPackages.Large - a.capacity.maxPackages.Large)[0];
console.log("Best for Large:", bestLarge.name, bestLarge.capacity.maxPackages);
